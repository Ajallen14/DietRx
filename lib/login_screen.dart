...
class _LoginScreenState extends State<LoginScreen> {
  // Key to trigger the flip animation
  ...
  Future<void> _signInWithGoogle() async {
    try {
      ...
      // 2. FORCE SIGNOUT: This clears the "remembered" account
      // so the account picker pops up every time.
      await googleSignIn.signOut(); 

      // 3. Now trigger the sign-in flow
