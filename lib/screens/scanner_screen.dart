              ...
              children: [
                  ...
                  children: [
                    Container(
                      ...
                      child: result.imageUrl != null 
                        ? Image.network(result.imageUrl!, errorBuilder: (c,o,s) => const Icon(Icons.fastfood, size: 50))
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(result.productName, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                          const SizedBox(height: 8),
                          Wrap(spacing: 8, runSpacing: 8, children: [
                            if (result.nutriscore != null) 
                              _buildBadge("Nutri-Score: ${result.nutriscore!.toUpperCase()}", Colors.blue),
                            if (result.novaGroup != null) 
                              _buildBadge("Nova: ${result.novaGroup}", _getNovaColor(result.novaGroup!)),
                          ]),
                        ],
                      ),
                    )
                ...
                if (!result.isSafe) ...[
                  ...
                  ...result.warnings.map((w) => ListTile(
                    ...
                    title: Text(w, style: const TextStyle(color: Colors.red, fontWeight: FontWeight.bold)),
                    dense: true,
                  )),
                  ...
                  if (result.alternatives.isNotEmpty) ...[
                     ...
                     const Align(
                       ...
                       child: Text("✅ Try These Instead (Tap for Info):", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold))
                     ),
                           ...
                           return GestureDetector(
                             ...
                             child: Container(
                               ...
                               decoration: BoxDecoration(
                                 ...
                                 boxShadow: [BoxShadow(color: Colors.grey.withOpacity(0.2), blurRadius: 4, offset: const Offset(2,2))]
                               ),
                               child: Column(
                                 children: [
                                   Expanded(
    ...
    showDialog(
      ...
      builder: (c) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
             const Text("✅ It belongs to the same specific category (e.g. Cola or Chocolate).", style: TextStyle(fontStyle: FontStyle.italic)),
             const SizedBox(height: 10),
             const Divider(),
             const SizedBox(height: 10),
